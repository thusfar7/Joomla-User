...
class UsersControllerProfile extends UsersController
{
	...
	public function save()
	{
        ...
        $ad_zupanija = $data['state'];
        $ad_city = $data['city'];
        $ad_address = $data['address'];
        $ad_phone = $data['contact1'];
        $ad_telefon = $data['contact2'];
        $ad_name = $data['name'];
        $ad_email = $data['email1'];
        $ad_id = $data['id'];
        $ad_oib = $data['oib'];

        $db = JFactory::getDbo();

        $db->setQuery("UPDATE `l0sav_adsmanager_profile` 
                            SET `name` = '".$ad_name."',
                            `email` = '".$ad_email."',
                            `ad_zupanija` = '".$ad_zupanija."',
                            `ad_city` = '".$ad_city."',
                            `ad_phone` = '".$ad_phone."',
