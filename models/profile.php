...
class UsersModelProfile extends JModelForm
{
	...
	public function getData()
	{
		if ($this->data === null)
		{
            ...
            $this->data->address = $this->data->get('address');
            $this->data->city = $this->data->get('city');
            $this->data->state = $this->data->get('state');
            $this->data->oib = $this->data->get('oib');
            $this->data->contact1 = $this->data->get('contact1');
            $this->data->contact2 = $this->data->get('contact2');
