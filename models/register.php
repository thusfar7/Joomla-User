...
/**
 * Register model class for Users.
 *
 * @since  1.6
 */
class UsersModelRegister extends JModelForm
{
    /**
    ...
    public function activate($token)
    {
        ...
        if (($userParams->get('useractivation') == 2) && !$user->getParam('activate', 0))
        {
            ...
            $data['activate'] = $base . JRoute::_('index.php?option=com_users&task=register.activate&token=' . $data['activation'], false);
    ...
    public function getData()
    {
        if ($this->data === null)
        {
            ...
            $temp = (array) $app->getUserState('com_users.register.data', array());
            ...
            $results = $dispatcher->trigger('onContentPrepareData', array('com_users.register', $this->data));
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_users.register', 'register', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function loadFormData()
    {
        ...
        $this->preprocessData('com_users.register', $data);
